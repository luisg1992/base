...
use Modules\Configuracion\Http\Controllers\FuenteFinanciamientoController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/fuente-financiamiento')
    ->middleware('auth')
    ->controller(FuenteFinanciamientoController::class)
    ->as($as)
