    ...
    <BaseModal :isVisible="isDialogOpen"
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <BaseInput v-model="form.Descripcion" label="Descripcion" placeholder="Ingrese la descripcion"
                               :disabled="isViewMode" :error="errors.Descripcion" required/>
                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <BaseInput v-model="form.Orden" label="Orden" placeholder="Ingrese la Orden"
                               :disabled="isViewMode" :error="errors.Orden" required type="number"/>
                </div>
            </div>
