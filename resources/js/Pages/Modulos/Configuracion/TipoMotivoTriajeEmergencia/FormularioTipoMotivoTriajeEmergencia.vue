    ...
    <BaseModal :isVisible="isDialogOpen"
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <BaseCombo v-model="form.IdServicio" :options="appStore.configuracionServicio"
                               label="Servicio"
                               :disabled="isViewMode" filter/>
                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <BaseCombo v-model="form.IdPrioridad" :options="appStore.configuracionPrioridad"
                               label="Prioridad"
                               :disabled="isViewMode" filter/>
                </div>

                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <BaseInput v-model="form.Descripcion" label="Descripcion" placeholder="Ingrese una descripcion"
