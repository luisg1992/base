<script setup>
import ModalFormulario from './FormularioTipoConsultorio.vue'
...
const resource = ref('configuracion/tipo-consultorio')
const refTable = ref()
...
const successAction = () => {
    // appStore.fetchTabla('configuracionTipoServicios');
