...
use Modules\Configuracion\Http\Controllers\RecetaViaAdministracionController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/receta-via-administracion')
    ->middleware('auth')
    ->controller(RecetaViaAdministracionController::class)
    ->as($as)
