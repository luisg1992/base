...
use Modules\Configuracion\Http\Controllers\TipoConsultorioController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/tipo-consultorio')
    ->middleware('auth')
    ->controller(TipoConsultorioController::class)
    ->as($as)
