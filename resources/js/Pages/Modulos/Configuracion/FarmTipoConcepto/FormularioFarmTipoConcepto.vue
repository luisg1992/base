    ...
    <BaseModal :isVisible="isDialogOpen"
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 ">
                <BaseInput v-model="form.Concepto" label="Concepto" placeholder="Ingrese un Concepto"
                           :disabled="isViewMode" :error="errors.Concepto"/>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 ">
                <BaseInput v-model="form.codigoMINSA" label="CodigoMinsa" placeholder="Ingrese un Codigo"
