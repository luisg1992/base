    ...
    <BaseModal :isVisible="isDialogOpen"
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-12">
                <div class="p-3 border rounded" style="border: 1px solid #7367f0!important; height: 125px;">
                    <BaseCombo v-model="tipoDocumento" :options="tiposDocumento"
                               optionLabel="label"
                               optionValue="value" label="BUSCAR POR:" :disabled="isViewMode"/>
                    <div class="d-flex align-items-center mt-2">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" ref="inputDocumentoRef"
                                   ...
                                   :disabled="isViewMode" v-model="nroDocumento" autocomplete="off" autofocus
                ...
                <div class="p-3 border rounded" style="border: 1px solid #7367f0!important;">
                    <div class="d-flex align-items-start">
                        <div class="me-3 position-relative">
                            <img :src="fotoPaciente" :key="fotoPaciente" alt="Foto paciente"
        ...
        <form @submit.prevent="guardar">
            ...
            <div class="row">
                ...
                <div class="col-xl-46 col-lg-6 col-md-12">
            ...
            <div class="row">
                ...
                <!-- Presión Arterial -->
                <div class="col-xl-4 col-lg-6 col-md-12">
                    <BaseInput v-model="form.FechaInicio" :label="'Fecha Inicio'"
                               :disabled="isViewMode" required type="date"/>
                </div>

                <!-- Presión Arterial -->
                <div class="col-xl-4 col-lg-6 col-md-12">
                    <BaseInput v-model="form.FechaFinal" :label="'Fecha Final'"
                               :disabled="isViewMode" required type="date"
                ...
                <!-- Presión Arterial -->
                <div class="col-xl-4 col-lg-6 col-md-12">
                    <BaseInput v-model="form.NumeroPlaca" :label="'Número Placa'"
                               :disabled="isViewMode" required type="text"
                ...
                <!-- Presión Arterial -->
                <div class="col-xl-4 col-lg-6 col-md-12">
                    <BaseInput v-model="form.NumeroPoliza" :label="'Número Póliza'"
                               :disabled="isViewMode" required type="text"
                ...
                <!-- Presión Arterial -->
                <div class="col-xl-4 col-lg-6 col-md-12">
                    <BaseInput v-model="form.NumeroSiniestro" :label="'Número Siniestro'"
                               :disabled="isViewMode" required type="text"
