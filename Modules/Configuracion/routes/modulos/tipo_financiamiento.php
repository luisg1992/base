...
use Modules\Configuracion\Http\Controllers\TipoFinanciamientoController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/tipo-financiamiento')
    ->middleware('auth')
    ->controller(TipoFinanciamientoController::class)
    ->as($as)
