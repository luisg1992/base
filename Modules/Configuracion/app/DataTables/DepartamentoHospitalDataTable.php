...
use Modules\Configuracion\Http\Resources\DepartamentoHospitalCollection;

trait DepartamentoHospitalDataTable
{
    use PaginationTrait;

    public function inicializarTabla()
    {
        $this->titulo_pagina = config('app.name') . ' | Departamentos';
        $this->titulo_tabla = 'DEPARTAMENTOS';
        $this->nombre_tabla = 'DepartamentosHospital';
    ...
    private function obtenerColumnasTabla(): array
    {
        ...
        $builder->agregarColumna(Column::make('Nombre')->label('Departamento')->sortable(true));
    ...
    public function records(Request $request)
    {
        ...
        $query = DepartamentoHospital::query()
        ...
        $query->orderBy('IdDepartamento');
        return (new DepartamentoHospitalCollection($query->paginate($this->limit)))->additional($this->metaAdditional);
    }
}
