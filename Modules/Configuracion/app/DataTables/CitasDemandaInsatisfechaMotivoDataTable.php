...
use Modules\Configuracion\Http\Resources\CitasDemandaInsatisfechaMotivoCollection;
use Modules\Configuracion\Models\CitasDemandaInsatisfechaMotivo;

trait CitasDemandaInsatisfechaMotivoDataTable
{
    use PaginationTrait;

    public function inicializarTabla()
    {
        $this->titulo_pagina = config('app.name') . ' | Citas - Demanda Insatisfecha';
        $this->titulo_tabla = 'MOTIVOS DEMANDA INSATISFECHA DE CITAS';
        $this->nombre_tabla = 'CitasDemandaInsatisfechaMotivo';
    ...
    public function records(Request $request)
    {
        ...
        $query = CitasDemandaInsatisfechaMotivo::query()
        ...
        $query->orderBy('IdDemandaInsatisfechaMotivo');
        return (new CitasDemandaInsatisfechaMotivoCollection($query->paginate($this->limit)))->additional($this->metaAdditional);
    }
}
