...
use Modules\Facturacion\Http\Controllers\ExpedienteJudicialController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('facturacion/expedientes-judiciales')
    ->middleware('auth')
    ->controller(ExpedienteJudicialController::class)
    ->as($as)
