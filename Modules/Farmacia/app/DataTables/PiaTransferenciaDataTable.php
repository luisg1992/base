...
trait PiaTransferenciaDataTable
{
    use PaginationTrait;

    public function inicializarTabla(): array
    {
        $this->titulo_pagina = config('app.name') . ' | Pia - Transferencia';
        $this->nombre_tabla = 'pia_transferencias';
        $this->titulo_tabla = 'Pia - Transferencia';
