...
use Modules\Configuracion\Http\Resources\TiposSolicitudInterconsultaCollection;
use Modules\Configuracion\Models\TiposSolicitudInterconsulta;

trait TiposSolicitudInterconsultaDataTable
{
    use PaginationTrait;

    public function inicializarTabla()
    {
        $this->titulo_pagina = config('app.name') . ' | Tipos Solicitud Interconsulta';
        $this->titulo_tabla = 'TIPOS SOLICITUD INTERCONSULTA';
        $this->nombre_tabla = 'TiposSolicitudInterconsulta';
    ...
    public function records(Request $request)
    {
        ...
        $query = TiposSolicitudInterconsulta::query()
        ...
        $query->orderBy('IdSolicitudInter');
        return (new TiposSolicitudInterconsultaCollection($query->paginate($this->limit)))->additional($this->metaAdditional);
    }
}
