<script setup>
import ModalFormulario from './FormularioTriajeEmergenciaFormaIngreso.vue'
...
const resource = ref('configuracion/formas-ingreso')
const refTable = ref()
...
const successAction = () => {
    appStore.fetchTabla('configuracionEmergenciaFormasIngreso');
