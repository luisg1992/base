...
use Modules\Configuracion\Http\Controllers\TriajeEmergenciaEstadoIngresoController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/estados-ingreso')
    ->middleware('auth')
    ->controller(TriajeEmergenciaEstadoIngresoController::class)
    ->as($as)
