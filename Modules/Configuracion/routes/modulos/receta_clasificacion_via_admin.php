...
use Modules\Configuracion\Http\Controllers\RecetaClasificacionViaAdminController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/receta-clasificacion-via-admin')
    ->middleware('auth')
    ->controller(RecetaClasificacionViaAdminController::class)
    ->as($as)
