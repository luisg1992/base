...
use Modules\Persona\Http\Controllers\TipoDocumentoIdentidadController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('personas/tipo-documentos-identidad')
    ->middleware('auth')
    ->controller(TipoDocumentoIdentidadController::class)
    ->as($as)
