...
{
    public function WebS_ListarDetalleApoyoDXAtencion(Request $request)
    {
        ...
        $productos_apoyo_dx = $AtencionMedicaReceta->obtenerDetalleReceta($request->IdCuentaAtencion, null);
        return response()->json([
            'success' => true,
            'codigo' => 'OK',
            'mensaje' => 'Receta Detalles obtenidos correctamente.',
            'data' => $productos_apoyo_dx
        ]);
    }
}
