...
use Modules\Configuracion\Http\Controllers\RecetaDosisUnidadMedidaController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/receta-dosis-unidad-medida')
    ->middleware('auth')
    ->controller(RecetaDosisUnidadMedidaController::class)
    ->as($as)
