    ...
    <BaseModal :isVisible="isDialogOpen"
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <BaseInput v-model="form.Nombres" label="Nombres" placeholder="Ingrese un Nombre"
                               :disabled="isViewMode" :error="errors.Nombres" required/>
                    <BaseInput v-model="form.Usuario" label="Usuario" placeholder="Ingrese un Usuario"
                               :disabled="isViewMode" :error="errors.Usuario" required/>
                    <BaseInput v-model="form.Clave" label="Clave" placeholder="Ingrese una Clave"
                               :disabled="isViewMode" :error="errors.Clave" required/>
                </div>
            </div>
