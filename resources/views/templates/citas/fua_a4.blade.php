...
<body>
    <main>
        <table
            style="width: 100%; height: 100%; table-layout: fixed; border-collapse: collapse; text-align:center; margin-top: 10px;">
            <tr>
                <td colspan="16" style="font-size: 14px;  padding-left: 20px;">
                    @if ($data['LogoOficial'])
                        <img src="data:image/png;base64,{{ $data['LogoOficial'] }}" width="100%">
                    @endif
                </td>
                <td colspan="18" style="font-size: 14px; text-align: center;" class="tamanio-5 mayuscula">ANEXO 1</td>
                <td colspan="16" style="text-align: right; padding-right: 20px;border-bottom: 1px solid white"
            ...
            <tr>
                ...
                <td colspan="18" class="tamanio-5  mayuscula "
                    style="border: 1px solid Black; border-collapse: collapse; text-align: center; background-color:#f7f5f5">
                    FORMATO ÚNICO DE ATENCIÓN - FUA</td>
                <td colspan="16" class="tamanio-5 mayuscula" style="border-top: 1px solid white">&nbsp;</td>
            </tr>
            <tr>
                <td colspan="18" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">NÚMERO DE FORMATO</td>
                <td colspan="16" rowspan="2" class="tamanio-10 mayuscula">CTA: {{ $data['Cuenta'] }}
                </td>
            </tr>
            <tr>
                <td colspan="7" style="border: 1px solid Black;" class="tamanio-7 mayuscula negrita">00006206</td>
                <td colspan="4" style="border: 1px solid Black;" class="tamanio-7 mayuscula negrita">
                    {{ $data['B'] }}</td>
                <td colspan="7" style="border: 1px solid Black;" class="tamanio-7 mayuscula negrita">
                    {{ $data['C'] }}</td>
            </tr>
            <tr>
                <td colspan="50"
                    style="border-top: 0px solid rgb(255, 255, 255);  border-left: 1px solid rgb(255, 255, 255); 
                    border-right: 1px solid rgb(255, 255, 255); 
                    border-bottom: 0px solid rgb(255, 255, 255);">
                </td>
            </tr>
            <tr>
                <td colspan="50" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">DE LA INSTITUCIÓN PRESTADORA DE SERVICIOS DE SALUD</td>
            </tr>
            <tr>
                <td colspan="12" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">CÓDIGO RENIPRESS DE LA IPRESS</td>
                <td colspan="38" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula "> NOMBRE DE LA IPRESS QUE REALIZA LA ATENCIÓN</td>
            </tr>
            <tr>
                <td colspan="12" style="border: 1px solid Black;" class="tamanio-5 mayuscula">00006206</td>
                <td colspan="38" style="border: 1px solid Black;" class="tamanio-5 mayuscula">HOSPITAL NACIONAL DOS DE
                    MAYO</td>
            </tr>
            <tr>
                <td colspan="12" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">PERSONAL QUE ATIENDE</td>
                <td colspan="7" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">LUGAR DE ATENCIÓN</td>
                <td colspan="7" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">ATENCIÓN</td>
                <td colspan="24" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">REFERENCIA REALIZADA POR</td>
            </tr>
            <tr>
                <td colspan="5" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">DE LA IPRESS</td>
                <td colspan="2" style="border: 1px solid Black;" class="tamanio-5 mayuscula">X</td>
                <td colspan="5" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                ...
                <td colspan="8" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
            ...
            <tr>
                ...
                <td colspan="2" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
                <td colspan="8" rowspan="2" style="border: 1px solid Black;"
                    class="tamanio-6 mayuscula negrita">
            ...
            <tr>
                <td colspan="11" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">IDENTIFICACIÓN</td>
                <td colspan="14" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">CÓDIGO DEL ASEGURADO SIS</td>
                <td colspan="25" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">ASEGURADO DE OTRA IAFAS</td>
            </tr>
            <tr>
                <td colspan="2" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">TDI</td>
                <td colspan="9" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-4-5  mayuscula ">N° DOCUMENTO DE IDENTIDAD</td>
                <td colspan="4" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">DIRESA / OTROS</td>
                <td colspan="10" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">NÚMERO</td>
                <td colspan="6" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">INSTITUCIÓN</td>
                <td colspan="19" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
            </tr>
            <tr>
                <td colspan="2" style="border: 1px solid Black;" class="tamanio-6 mayuscula negrita">
                    {{ $data['TDI'] }}
                </td>
                <td colspan="9" style="border: 1px solid Black;" class="tamanio-6 mayuscula negrita">
                    {{ $data['DocumentoIdentidad'] }}</td>
                <td colspan="4" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
                <td colspan="10" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
                <td colspan="6" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
            ...
            <tr>
                <td colspan="25" style="border: 1px solid Black;" class="tamanio-6 mayuscula negrita">
            ...
            <tr>
                ...
                <td colspan="8" rowspan="2"
                    style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                ...
                <td colspan="7" rowspan="2" style="border: 1px solid Black;" class="tamanio-5 mayuscula">
                    &nbsp;</td>
                <td colspan="10" rowspan="2" style="border: 1px solid Black;"
                    class="tamanio-6 mayuscula negrita">
            ...
            <tr>
                <td colspan="16" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
            ...
            <tr>
                ...
                <td colspan="13" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
            ...
            <tr>
                ...
                <td colspan="12" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
            </tr>
            <tr>
                <td colspan="50" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
            ...
            <tr>
                ...
                <td colspan="2" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
                <td colspan="3" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
            ...
            <tr>
                ...
                <td rowspan="2" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
                <td colspan="2" rowspan="2"
                    style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
            ...
            <tr>
                <td colspan="4" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">EMERGENCIA</td>
                <td style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
                <td colspan="5" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
            ...
            <tr>
                <td height="10" colspan="16" class="tamanio-5 mayuscula" style="border: 1px solid Black;">
                    &nbsp;</td>
                <td colspan="18" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
                <td colspan="16" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
            </tr>
            <tr>
                <td colspan="31" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
                    class="tamanio-5  mayuscula ">ACTIVIDADES PREVENTIVAS Y OTROS</td>
                <td colspan="19" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
            ...
            <tr>
                ...
                <td style="border: 1px solid Black; text-align: center;" class="tamanio-5 mayuscula">&nbsp;</td>
                <td style="border: 1px solid Black; text-align: center;" class="tamanio-5 mayuscula">&nbsp;</td>
            </tr>
            <tr>
                <td colspan="4" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
            ...
            <tr>
                ...
                <td colspan="15" style="border: 1px solid Black; text-align: center; background-color:#f7f5f5"
            ...
            <tr>
                <td colspan="2" style="border: 1px solid Black; text-align: center;" class="tamanio-5 mayuscula">
                    1</td>
                <td colspan="21" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
                <td colspan="9" style="border: 1px solid Black; text-align: center;" class="tamanio-5 mayuscula">
                    &nbsp;</td>
                <td colspan="6" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
                <td colspan="6" style="border: 1px solid Black; text-align: center;" class="tamanio-5 mayuscula">
                    &nbsp;</td>
                <td colspan="6" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" style="border: 1px solid Black; text-align: center;"
                    class="tamanio-5 mayuscula">3</td>
                <td colspan="21" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
            ...
            <tr>
                <td colspan="2" style="border: 1px solid Black; text-align: center;"
                    class="tamanio-5 mayuscula">4</td>
                <td colspan="21" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
                <td colspan="9" style="border: 1px solid Black; text-align: center;"
                    class="tamanio-5 mayuscula">&nbsp;</td>
                <td colspan="6" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
            ...
            <tr>
                <td colspan="2" style="border: 1px solid Black; text-align: center;"
                    class="tamanio-5 mayuscula">5</td>
                <td colspan="21" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
                <td colspan="9" style="border: 1px solid Black; text-align: center;"
                    class="tamanio-5 mayuscula">&nbsp;</td>
                <td colspan="6" style="border: 1px solid Black;" class="tamanio-5 mayuscula">&nbsp;</td>
            ...
            <tr>
                ...
                <td class="tamanio-5 mayuscula" style="border: 1px solid Black;">&nbsp;</td>
            ...
            <tr>
                ...
                <td colspan="13" class="tamanio-5 mayuscula">&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td colspan="24">&nbsp;</td>
            ...
            <tr>
                ...
                <td class="tamanio-5 mayuscula" style="text-align:left;">:</td>
                <td colspan="13" class="tamanio-5 mayuscula" style="text-align:left;">&nbsp;</td>
                <td colspan="9" rowspan="2" style="text-align:center;" class="tamanio-5 ">Huella Digital
                    del Asegurado o del
                    Representante</td>
            </tr>
            <tr>
        ...
        <table
            ...
            <tr>
                <td colspan="50"
                    style="border: 1px solid Black; text-align: center; background-color:#f7f5f5; font-family: Arial, Helvetica, sans-serif;"
