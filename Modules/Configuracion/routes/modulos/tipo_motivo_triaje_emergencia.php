...
use Modules\Configuracion\Http\Controllers\TipoMotivoTriajeEmergenciaController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/tipo_motivo_triaje_emergencia')
    ->middleware('auth')
    ->controller(TipoMotivoTriajeEmergenciaController::class)
    ->as($as)
