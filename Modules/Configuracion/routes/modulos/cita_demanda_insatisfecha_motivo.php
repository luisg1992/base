...
use Modules\Configuracion\Http\Controllers\CitasDemandaInsatisfechaMotivoController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/cita-demanda-insatisfecha-motivo')
    ->middleware('auth')
    ->controller(CitasDemandaInsatisfechaMotivoController::class)
    ->as($as)
