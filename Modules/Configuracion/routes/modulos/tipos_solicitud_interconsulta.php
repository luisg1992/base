...
use Modules\Configuracion\Http\Controllers\TiposSolicitudInterconsultaController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/tipos-solicitud-interconsulta')
    ->middleware('auth')
    ->controller(TiposSolicitudInterconsultaController::class)
    ->as($as)
