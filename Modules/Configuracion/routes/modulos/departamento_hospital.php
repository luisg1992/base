...
use Modules\Configuracion\Http\Controllers\DepartamentoHospitalController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/departamentos-hospital')
    ->middleware('auth')
    ->controller(DepartamentoHospitalController::class)
    ->as($as)
