...
use Modules\Configuracion\Http\Controllers\TriajeEmergenciaFormaIngresoController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/formas-ingreso')
    ->middleware('auth')
    ->controller(TriajeEmergenciaFormaIngresoController::class)
    ->as($as)
