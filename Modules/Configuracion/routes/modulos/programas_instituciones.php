...
use Modules\Configuracion\Http\Controllers\ProgramaInstitucionController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/programas-instituciones')
    ->middleware('auth')
    ->controller(ProgramaInstitucionController::class)
    ->as($as)
