...
const onSubmit = async () => {
    ...
    if (confirmado) {
        ...
        const formData = {
            ...
            TipoEmpleadoHIS: form.TipoEmpleadoHIS,
            EsProgramado: form.EsProgramado,
            TipoEmpleadoSIS: form.TipoEmpleadoSIS,
            EsColegiatura: form.EsColegiatura,
            TipoEspecialidadSIS: form.TipoEspecialidadSIS,
            Estado: form.Estado
        };
...
<template>
    <BaseModal :isVisible="isDialogOpen"
            ...
            <div class="row">
                ...
                <div class="col-6 col-sm-12 col-md-6 col-lg-6">
                    <BaseInput v-model="form.TipoEmpleadoHIS" label="Tipo Empleado HIS"
                               placeholder="Ingrese una Tipo Empleado HIS"
                               :disabled="isViewMode" :error="errors.TipoEmpleadoHIS"/>
                </div>
            </div>
            <div class="row">
                <div class="col-6 col-sm-12 col-md-6 col-lg-6">
                    <BaseInput v-model="form.EsProgramado" label="Es Programado" placeholder="Ingrese el ES PROGRAMADA"
                               :disabled="isViewMode" :error="errors.EsProgramado"/>
                </div>

                <div class="col-6 col-sm-12 col-md-6 col-lg-6">
                    <BaseInput v-model="form.TipoEmpleadoSIS" label="Tipo Empleado SIS"
                               placeholder="Ingrese el Tipo Empleado SIS"
                               :disabled="isViewMode" :error="errors.TipoEmpleadoSIS"/>
                </div>
            </div>
            <div class="row">
                <div class="col-6 col-sm-12 col-md-6 col-lg-6">
                    <BaseInput v-model="form.EsColegiatura" label="Es Colegiatura" placeholder="Ingrese la Colegiatura"
                               :disabled="isViewMode" :error="errors.EsColegiatura"/>
                </div>

                <div class="col-6 col-sm-12 col-md-6 col-lg-6">
                    <BaseInput v-model="form.TipoEspecialidadSIS" label="Tipo Especialidad SIS"
                               placeholder="Ingrese el Tipo Especialidad SIS"
                               :disabled="isViewMode" :error="errors.TipoEspecialidadSIS"/>
                </div>
            </div>
