...
//            'package' => 'package.json',
        ...
        'replacements' => [
            ...
            'routes/tenant' => ['LOWER_NAME', 'STUDLY_NAME', 'MODULE_NAMESPACE', 'CONTROLLER_NAMESPACE'],
    ...
    'paths' => [
        ...
        */
        'generator' => [
            ...
            'data-tables' => ['path' => 'app/DataTables', 'generate' => true],
            'requests' => ['path' => 'app/Http/Requests', 'generate' => true],
            'resources' => ['path' => 'app/Http/Resources', 'generate' => true],
            'observers' => ['path' => 'app/Observers', 'generate' => true],
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'webgalen'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'WebGalen'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'sigesa.his@gmail.com'),
        ],
