...
use Modules\Configuracion\Http\Controllers\ProgramaTipoDocumentoController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/programas-tipos-documentos')
    ->middleware('auth')
    ->controller(ProgramaTipoDocumentoController::class)
    ->as($as)
