...
class TipoEmpleadoCollection extends ResourceCollection
{
    /**
    ...
    public function toArray(Request $request): Collection
    {
        ...
        return $this->collection->transform(function ($row, $key) use ($valorPermission, $acciones) {
            ...
            return [
                ...
                'TipoEmpleadoHIS' => $row->TipoEmpleadoHIS,
                'EsProgramado' => $row->EsProgramado,
                'TipoEmpleadoSIS' => $row->TipoEmpleadoSIS,
                'EsColegiatura' => $row->EsColegiatura,
                'TipoEspecialidadSIS' => $row->TipoEspecialidadSIS,
