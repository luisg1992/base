    ...
    <BaseModal :isVisible="isDialogOpen"
            ...
            <div class="row">
                <div class="col-6 col-sm-12 col-md-12 col-lg-12">
                    <BaseInput v-model="form.desetni" label="Descripción" placeholder="Ingrese una descripción"
                               :disabled="isViewMode" :error="errors.desetni"/>
                </div>
                <div class="col-6 col-sm-12 col-md-12 col-lg-12">
                    <BaseInput v-model="form.codgen" label="Codigo Gen" placeholder="Ingrese un codigo"
                               :disabled="isViewMode" :error="errors.codgen"/>
                </div>
            </div>
            <div class="row">
                <div class="col-6 col-sm-12 col-md-12 col-lg-12">
                    <BaseInput v-model="form.etnias" label="Etnias" placeholder="Ingrese una etnia"
                               :disabled="isViewMode" :error="errors.etnias"/>
                </div>
                <div class="col-6 col-sm-12 col-md-12 col-lg-12">
                    <BaseInput v-model="form.id_etnia" label="Codigo Etnias" placeholder="Ingrese un codigo"
                               :disabled="isViewMode" :error="errors.id_etnia"/>
                </div>
            </div>
