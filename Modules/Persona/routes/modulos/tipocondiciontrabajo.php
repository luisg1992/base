...
use Modules\Persona\Http\Controllers\TipoCondicionTrabajoController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('personas/condiciontrabajo')
    ->middleware('auth')
    ->controller(TipoCondicionTrabajoController::class)
    ->as($as)
