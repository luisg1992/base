...
const onSubmit = async () => {
    ...
    if (confirmado) {
        ...
        const formData = {
            ...
            OrdenPrioridad: form.OrdenPrioridad,
...
<template>
    <BaseModal :isVisible="isDialogOpen"
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                <BaseInput v-model="form.OrdenPrioridad" label="Orden Prioridad" placeholder="Ingrese un valor"
                           :disabled="isViewMode" :error="errors.OrdenPrioridad" type="number"/>
            </div>
        </div>
