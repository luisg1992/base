    ...
    <main>
        <table style="width: 100%; table-layout: fixed; border-collapse: collapse;">
            ...
            <tr class="tabla-sin-bordes">
                <td colspan="50" class="tamanio-13 negrita" style="text-align: center;">HOJA DE PROCEDIMIENTOS</td>
            </tr>
            <tr>
                ...
                @foreach ($data['ItemProcedimientos'] as $item)
                    <tr>
                        <td colspan="50" class="tamanio-7 mayuscula">
                            <hr style="border: 0.1px solid #999; width: 100%; margin: 8px auto;">
                        </td>
                    </tr>
                    <tr class="tabla-sin-bordes">
                        <td colspan="6" class="tamanio-7 mayuscula">PROCEDIMIENTO</td>
                        <td colspan="1" class="tamanio-7 mayuscula">:</td>
                        <td colspan="35" class="tamanio-7 mayuscula">{{ $item['Procedimiento'] }}</td>
                        <td colspan="4" class="tamanio-7 mayuscula">CANTIDAD</td>
                        <td colspan="1" class="tamanio-7 mayuscula">:</td>
                        <td colspan="27" class="tamanio-7 mayuscula">{{ $item['Cantidad'] }}</td>
                    </tr>
                    <tr>
                        <td colspan="6" class="tamanio-7 mayuscula">DIAGNOSTICO</td>
                        <td colspan="1" class="tamanio-7 mayuscula">:</td>
                        <td colspan="43" class="tamanio-7 mayuscula">{{ $item['Diagnostico'] }}</td>
                    </tr>
                    <tr>
                        <td colspan="6" class="tamanio-7 mayuscula">JUSTIFICACIÓN</td>
                        <td colspan="1" class="tamanio-7 mayuscula">:</td>
                        <td colspan="43" class="tamanio-7 mayuscula">
                            {{ $item['Justificacion'] ? $item['Justificacion'] : '-' }}</td>
                    </tr>
                    <tr>
                        <td colspan="6" class="tamanio-7 mayuscula">OBSERVACIÓN </td>
                        <td colspan="1" class="tamanio-7 mayuscula">:</td>
                        <td colspan="43" class="tamanio-7 mayuscula">
                            {{ $item['Observacion'] ? $item['Observacion'] : '-' }}</td>
                    </tr>
                @endforeach
            @endif
