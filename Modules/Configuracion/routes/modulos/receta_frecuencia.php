...
use Modules\Configuracion\Http\Controllers\RecetaFrecuenciaController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/receta-frecuencia')
    ->middleware('auth')
    ->controller(RecetaFrecuenciaController::class)
    ->as($as)
