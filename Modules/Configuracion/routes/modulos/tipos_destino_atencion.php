...
use Modules\Configuracion\Http\Controllers\TiposDestinoAtencionController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/tipos-destino-atencion')
    ->middleware('auth')
    ->controller(TiposDestinoAtencionController::class)
    ->as($as)
