...
trait AdmisionEmergenciaDataTable
{
    use PaginationTrait;

    public function inicializarTabla()
    {
        $this->titulo_pagina = config('app.name') . ' | Admisión Emergencia';
        $this->titulo_tabla = 'Admisión Emergencia';
        $this->nombre_tabla = 'AdmisionEmergencia';
...
//        );
    ...
    public function records(Request $request)
    {
        ...
        return (new AdmisionEmergenciaCollection($this->getFilterRecords($request)));
    }
    ...
    private function getFilterRecords(Request $request)
    {
        ...
        $params = [
            $IdTipoServicio,
            $IdServicio,
            Carbon::createFromFormat('d/m/Y', $Fecha)->format('Y-m-d'),
            $Prioridad,
            $Paciente,
