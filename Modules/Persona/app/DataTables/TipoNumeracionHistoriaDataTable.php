...
use Modules\Persona\Http\Resources\TipoNumeracionHistoriaCollection;


trait TipoNumeracionHistoriaDataTable
{
    use PaginationTrait;

    public function inicializarTabla()
    {
        $this->titulo_pagina = config('app.name') . ' | Tipo Numeracion';
        $this->titulo_tabla = 'TIPOS NUMERACION';
        $this->nombre_tabla = 'TipoNumeracion';
    ...
    private function obtenerColumnasTabla(): array
    {
        ...
        $builder->agregarColumna(Column::make('Descripcion')->label('Tipo Numeracion')->sortable(true));
    ...
    public function records(Request $request)
    {
        ...
        $query = TipoNumeracionHistoria::query()
        ...
        $query->orderBy('IdTipoNumeracion', 'asc');
        return (new TipoNumeracionHistoriaCollection($query->paginate($this->limit)))->additional($this->metaAdditional);
    }
}
