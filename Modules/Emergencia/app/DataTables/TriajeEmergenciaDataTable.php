...
trait TriajeEmergenciaDataTable
{
    use PaginationTrait;
    ...
    public function inicializarTabla()
    {
        ...
        $this->titulo_tabla = 'TRIAJE EMERGENCIA';
        $this->nombre_tabla = 'TriajeEmergencia';
...
//            ->whereMonth('TriajeFecha', $MesArray[0])
//            ->whereYear('TriajeFecha', $MesArray[1])
        ...
        return (new TriajeEmergenciaCollection($query->paginate($this->limit)))->additional($this->metaAdditional);
    }
}
