...
use Modules\Farmacia\Http\Resources\NotaSalidaFarmaciaCollection;
use Modules\Farmacia\Models\NotaSalidaFarmacia;

trait NotaSalidaFarmaciaDataTable
{
    use PaginationTrait;

    public function initTable(): array
    {
        $this->pageTitle = config('app.name') . ' | Notas de Salida Farmacias';
        $this->tableName = 'farmacias';
        $this->tableTitle = 'Listado de notas de salida a farmacias';
    ...
    public function getRecords(Request $request)
    {
        ...
        return (new NotaSalidaFarmaciaCollection($query->paginate($this->perPage)))->additional($this->metaAdditional);
    }

    private function getFilterRecords()
    {
        $query = NotaSalidaFarmacia::query();
