...
use Modules\Configuracion\Http\Controllers\TipoGravedadAtencionController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/tipo-gravedad-atencion')
    ->middleware('auth')
    ->controller(TipoGravedadAtencionController::class)
    ->as($as)
