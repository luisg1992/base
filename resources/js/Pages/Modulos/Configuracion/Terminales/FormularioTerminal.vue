...
const onSubmit = async () => {
    ...
    if (confirmado) {
        ...
        const formData = {
            ...
            Estado: form.Estado,
            IdUbicacionesFisicas: form.IdUbicacionesFisicas,
        };
...
<template>
    <BaseModal :isVisible="isDialogOpen"
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <BaseCombo v-model="form.IdUbicacionesFisicas" :options="appStore.configuracionUbicacionesFisicas"
                           label="Ubicaciones Físicas" :disabled="isViewMode" :filter="true"/>
            </div>

            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                <BaseInput v-model="form.Nombre" label="HostName" placeholder="Descripción" :disabled="isViewMode"
                           :error="errors.Nombre"/>
            </div>

            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                <BaseInput v-model="form.IpAddress" label="IPV4" placeholder="Descripción" :disabled="isViewMode"
                           :error="errors.IpAddress"/>
            </div>

            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                <BaseInput v-model="form.IpV6" label="IPV6" placeholder="Descripción" :disabled="isViewMode"
                           :error="errors.IpV6"/>
            </div>

            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                <BaseInput v-model="form.MacAddress" label="MAC" placeholder="Descripción" :disabled="isViewMode"
