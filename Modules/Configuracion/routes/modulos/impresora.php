...
use Modules\Configuracion\Http\Controllers\ImpresoraController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/impresora')
    ->middleware('auth')
    ->controller(ImpresoraController::class)
    ->as($as)
    ->group(function () use ($as) {
        ...
        Route::post('/lista-tablas', 'listarTablas')->name('tablas');
    });
