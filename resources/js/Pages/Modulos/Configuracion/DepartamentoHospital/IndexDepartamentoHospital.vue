<script setup>
import ModalFormulario from './FormularioDepartamentoHospital.vue'
...
const resource = ref('configuracion/departamentos-hospital')
const refTable = ref()
...
const successAction = () => {
    appStore.fetchTabla('configuracionDepartamentosHospital');
