...
<template>
    <BaseModal :isVisible="isDialogOpen"
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                <BaseInput v-model="form.HoraInicio"
                           label="HoraInicio"
                           placeholder="Ingrese una Hora Inicio"
                           :disabled="isViewMode"
                           :error="errors.HoraInicio"
                           type="time"/>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                <BaseInput v-model="form.HoraFin"
                           label="HoraFin"
                           placeholder="Ingrese una Hora Fin"
                           :disabled="isViewMode"
                           :error="errors.HoraFin"
                           type="time"/>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                <BaseCombo v-model="form.IdTipoTurnoRef"
                           :options="appStore.programacionGeneralTipoTunos"
                           label="Turno"
                           :show-Clear="!isViewMode"
                           :disabled="isViewMode"/>
            </div>
            <div class="col-12 col-sm-6 col-md-12 col-lg-12">
                <BaseCombo v-model="form.IdTipoServicio"
