...
import ModalFormulario from './FormularioEspecialidadPrimaria.vue';
...
const resource = ref('configuracion/especialidades-primarias')
const refTable = ref()
...
const successAction = () => {
    appStore.fetchTabla('configuracionEspecialidadesPrimarias');
