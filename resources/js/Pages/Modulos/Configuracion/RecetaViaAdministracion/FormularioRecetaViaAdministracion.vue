...
<template>
    <BaseModal :isVisible="isDialogOpen"
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <BaseCombo v-model="form.IdCategoria" label="Categoria" :options="appStore.tablasCache.recetaClasificacionViaAdminCache"
                            :disabled="isViewMode" :error="errors.IdCategoria" required/>
                </div>
            </div>
