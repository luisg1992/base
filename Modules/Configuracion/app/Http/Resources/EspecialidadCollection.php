    ...
    public function toArray(Request $request): Collection
    {
        ...
        return $this->collection->transform(function ($row, $key) use ($valorPermission, $acciones) {
            ...
            return [
                ...
                'Departamento' => optional($row->departamento)->Nombre,
                'TiempoPromedioAtencion' => $row->TiempoPromedioAtencion,
                'IdEspecialidadPrimaria' => $row->IdEspecialidadPrimaria,
                'EspecialidadPrimaria' => optional($row->especialidadPrimaria)->Nombre,
