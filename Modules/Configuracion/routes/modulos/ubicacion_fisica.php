...
use Modules\Configuracion\Http\Controllers\UbicacionFisicaController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/ubicaciones-fisicas')
    ->middleware('auth')
    ->controller(UbicacionFisicaController::class)
    ->as($as)
