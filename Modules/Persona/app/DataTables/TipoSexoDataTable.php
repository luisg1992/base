...
trait TipoSexoDataTable
{
    use PaginationTrait;

    public function inicializarTabla()
    {
        $this->titulo_pagina = config('app.name') . ' | Tipo Sexo';
        $this->titulo_tabla = 'TIPOS SEXO';
        $this->nombre_tabla = 'TipoSexo';
    ...
    private function obtenerColumnasTabla(): array
    {
        ...
        $builder->agregarColumna(Column::make('Descripcion')->label('Tipo Sexo ')->sortable(true));
    ...
    public function records(Request $request)
    {
        ...
        $query->orderBy('IdTipoSexo', 'asc');
        return (new TipoSexoCollection($query->paginate($this->limit)))->additional($this->metaAdditional);
    }
}
