...
use Modules\Configuracion\Http\Controllers\CajaTipoComprobanteController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/caja-tipo-comprobante')
    ->middleware('auth')
    ->controller(CajaTipoComprobanteController::class)
    ->as($as)
