<script setup>
import ModalFormulario from './FormularioUbicacionFisica.vue'
...
const resource = ref('configuracion/ubicaciones-fisicas')
const refTable = ref()
...
const successAction = () => {
    appStore.fetchTabla('configuracionUbicacionesFisicas');
