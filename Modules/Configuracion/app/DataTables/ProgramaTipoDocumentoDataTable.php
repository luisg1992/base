...
use Modules\Configuracion\Http\Resources\ProgramaTipoDocumentoCollection;
use Modules\Configuracion\Models\ProgramaTipoDocumento;

trait ProgramaTipoDocumentoDataTable
{
    use PaginationTrait;

    public function inicializarTabla()
    {
        $this->titulo_pagina = config('app.name') . ' | Programas Tipos Documentos';
        $this->titulo_tabla = 'PROGRAMAS TIPOS DOCUMENTOS';
        $this->nombre_tabla = 'ProgramaTipoDocumento';
    ...
    public function records(Request $request)
    {
        ...
        $query = ProgramaTipoDocumento::query()
        ...
        $query->orderBy('IdTipoDocumento');
        return (new ProgramaTipoDocumentoCollection($query->paginate($this->limit)))->additional($this->metaAdditional);
    }
}
