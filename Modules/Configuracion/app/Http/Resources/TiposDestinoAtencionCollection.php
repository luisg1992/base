...
class TiposDestinoAtencionCollection extends ResourceCollection
{
    /**
    ...
    public function toArray(Request $request): Collection
    {
        ...
        return $this->collection->transform(function ($row, $key) use ($valorPermission, $acciones) {
            ...
            return [
                'id' => $row->IdDestinoAtencion,
                'Codigo' => $row->Codigo,
                'Descripcion' => $row->Descripcion,
                //'IdTipoServicio' => $row->IdTipoServicio,
                //'TipoServicioHosp' => $row->TipoServicioHosp,
                //'DestinoSEM' => $row->DestinoSEM,
                //'id_destinoAseguradoSIS' => $row->id_destinoAseguradoSIS,
