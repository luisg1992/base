...
use Modules\Persona\Http\Controllers\TipoNumeracionHistoriaController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('personas/tipo-numeracion-historia')
    ->middleware('auth')
    ->controller(TipoNumeracionHistoriaController::class)
    ->as($as)
