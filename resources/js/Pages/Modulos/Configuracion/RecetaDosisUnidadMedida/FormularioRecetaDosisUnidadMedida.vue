...
const onSubmit = async () => {
    ...
    if (confirmado) {
        ...
        const formData = {
            ...
            DosisUnidadMedida: form.DosisUnidadMedida,
    ...
    <BaseModal :isVisible="isDialogOpen"
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <BaseInput v-model="form.DosisUnidadMedida" label="Dosis Unidad de Medida" placeholder="Ingrese la unidad de medida"
                               :disabled="isViewMode" :error="errors.DosisUnidadMedida" required/>
                </div>
            </div>
