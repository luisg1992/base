<script setup>
import ModalFormulario from './FormularioCitasDemandaInsatisfechaMotivo.vue'
...
const resource = ref('configuracion/cita-demanda-insatisfecha-motivo')
const refTable = ref()
...
const successAction = () => {
    appStore.fetchTabla('CitasDemandaInsatisfechaMotivo');
