<script setup>
import ModalFormulario from './FormularioTipoFinanciamiento.vue'
...
const resource = ref('configuracion/tipo-financiamiento')
const refTable = ref()
...
const successAction = () => {
    appStore.fetchTabla('configuracionTipoFinanciamiento');
...
<template>
        <BaseDataTable ref="refTable" :resource="resource" @actions="successActions" @success-delete="successAction" @success-active="successAction"/>
