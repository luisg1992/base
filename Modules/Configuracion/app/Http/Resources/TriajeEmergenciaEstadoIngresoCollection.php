...
class TriajeEmergenciaEstadoIngresoCollection extends ResourceCollection
{
    /**
    ...
    public function toArray(Request $request): Collection
    {
        ...
        return $this->collection->transform(function ($row, $key) use ($valorPermission, $acciones) {
            ...
            return [
                'id' => $row->IdEstadoIngreso,
                'IdFormaIngreso' => $row->IdFormaIngreso,
                'FormaIngreso' => strtoupper(optional($row->formaIngreso)->Descripcion),
