...
use Modules\Persona\Http\Controllers\TipoGradoInstruccionController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('personas/tipo-grado-instruccion')
    ->middleware('auth')
    ->controller(TipoGradoInstruccionController::class)
    ->as($as)
