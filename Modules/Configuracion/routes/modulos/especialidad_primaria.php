...
use Modules\Configuracion\Http\Controllers\EspecialidadPrimariaController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/especialidades-primarias')
    ->middleware('auth')
    ->controller(EspecialidadPrimariaController::class)
    ->as($as)
