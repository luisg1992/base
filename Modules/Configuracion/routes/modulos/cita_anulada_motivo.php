...
use Modules\Configuracion\Http\Controllers\CitaAnuladaMotivoController;

$as = ModuloHelper::obtenerPermisoBaseDesdeRuta();

Route::prefix('configuracion/cita-anulada-motivo')
    ->middleware('auth')
    ->controller(CitaAnuladaMotivoController::class)
    ->as($as)
