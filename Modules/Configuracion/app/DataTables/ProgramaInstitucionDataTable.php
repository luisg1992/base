...
use Modules\Configuracion\Http\Resources\ProgramaInstitucionCollection;
use Modules\Configuracion\Models\ProgramaInstitucion;

trait ProgramaInstitucionDataTable
{
    use PaginationTrait;

    public function inicializarTabla()
    {
        $this->titulo_pagina = config('app.name') . ' | Programas Instituciones';
        $this->titulo_tabla = 'PROGRAMAS INSTITUCIONES';
        $this->nombre_tabla = 'ProgramaInstitucion';
    ...
    public function records(Request $request)
    {
        ...
        $query = ProgramaInstitucion::query()
        ...
        $query->orderBy('IdInstitucion');
        return (new ProgramaInstitucionCollection($query->paginate($this->limit)))->additional($this->metaAdditional);
    }
}
